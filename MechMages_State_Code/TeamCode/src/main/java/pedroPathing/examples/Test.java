...
public class Test extends OpMode {
    ...
    private final Pose interPose = new Pose(24, 0, Math.toRadians(0));
    private final Pose nextPose = new Pose(24, -5, Math.toRadians(0));
    private final Pose endPose = new Pose(0, -5, Math.toRadians(0));
    ...
    public void init() {
        ...
        testPath = follower.pathBuilder()
                ...
                .addPath(new BezierLine(new Point(interPose), new Point(nextPose)))
                .setLinearHeadingInterpolation(interPose.getHeading(), nextPose.getHeading())
                .addPath(new BezierLine(new Point(nextPose), new Point(endPose)))
                .setLinearHeadingInterpolation(nextPose.getHeading(), endPose.getHeading())
                .build();
