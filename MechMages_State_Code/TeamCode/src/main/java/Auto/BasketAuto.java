...
@Config
@Autonomous(name = "BasketAutoFinal", group = "Examples")
public class BasketAuto extends OpMode {
    ...
    private final Pose scorePose = new Pose(18, 129, Math.toRadians(315)); //20
    ...
    public void buildPaths() {
        ...
        scorePreload = follower.pathBuilder()
                ...
                .addParametricCallback(0.1, () -> slidesRunUP(2450))
                .addParametricCallback(0.1, this:: depoSample)
        ...
        grabPickup1 = follower.pathBuilder()
                ...
                .addParametricCallback(0.1, () -> hortForward(500))
                .addParametricCallback(0.25, this:: depoReset)
        ...
        scorePickup1 = follower.pathBuilder()
                ...
                .addParametricCallback(0.1, () -> slidesRunUP(2450))
                .addParametricCallback(0.1, this:: depoSample)
                .addParametricCallback(0.9, this:: openClaw)
        ...
        grabPickup2 = follower.pathBuilder()
                ...
                .addParametricCallback(0.1, () -> hortForward(600))
                .addParametricCallback(0.25,this:: vertReset)//Todo: might need to change to lambda func
                .addParametricCallback(0.25, this:: depoReset)
        ...
        park =  follower.pathBuilder()
                ...
                .addParametricCallback(0.2,this:: vertReset)
        ...
        switch (pathState) {
            ...
            case 1:
                ...
                if(!follower.isBusy()) {
                    ...
                    //Todo Add in traj and see if it any diff
                    vertReset();
                    vertStop();
                    setPathState(2);
                }
            ...
            case 5:
                ...
                if(!follower.isBusy()) {
                    ...
                    follower.followPath(grabPickup3,true);
                      /*  runIntake(1000);//Todo Add in traj and see if it any diff
                        hortReset();
                        closeClaw();
                        setPathState(6);
    ...
    public void hortForward(int pos){
        intakeTilt.setPosition(0.8);
        extension.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
        extension.setMode(DcMotor.RunMode.RUN_USING_ENCODER);
        extension.setTargetPosition(pos * -1);
        extension.setPower(1);
        extension.setMode(DcMotor.RunMode.RUN_TO_POSITION);
    }

    public void hortReset(){
    ...
    public void vertReset(){
        if(!vertSwitch.isPressed()){
            ...
            leftVerticalMotor.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
            rightVerticalMotor.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
            leftVerticalMotor.setMode(DcMotor.RunMode.RUN_USING_ENCODER); //might need to comment out
            rightVerticalMotor.setMode(DcMotor.RunMode.RUN_USING_ENCODER); //might need to comment out
        }

    }

    public void vertStop(){
        leftVerticalMotor.setPower(0);
        rightVerticalMotor.setPower(0);
    ...
    public void runIntake(double time) {
        long startTime = opmodeTimer.getElapsedTime(); // Store the starting time
        while ((startTime + time * 1000) > opmodeTimer.getElapsedTime()) {
            intakeTilt.setPosition(0.8);
            intake.setPower(-1);
            telemetry.addData("Intaking", opmodeTimer.getElapsedTime());
            telemetry.update();
        }
        intake.setPower(0);
    }
